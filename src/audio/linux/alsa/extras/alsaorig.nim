...
proc snd_pcm_format_name*(format: snd_pcm_format_t): cstring
    {.cdecl, dynlib: Lib, importc: "snd_pcm_format_name".}

proc snd_pcm_format_physical_width*(format: snd_pcm_format_t): cint
...
proc snd_pcm_hw_params_set_format*(pcm: PcmPtr,
                                  params: HwParamsPtr,
                                  val: snd_pcm_format_t): cint
...
proc snd_pcm_open*(pcm: ptr PcmPtr, name: cstring, stream: snd_pcm_stream_t,
                   mode: cint): cint
...
proc snd_pcm_state*(pcm: PcmPtr): snd_pcm_state_t
